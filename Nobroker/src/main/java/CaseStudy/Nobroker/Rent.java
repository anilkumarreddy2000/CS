...
public class Rent {
	public static void main(String[] args) {
		...
		/*
		* List<WebElement>dynamicList=driver.findElements(By.cssSelector(
		* "div[class='autocomplete-dropdown-container']"));
		*
		* //div[class='autocomplete-dropdown-container']
		*
		* for(int i=0;i<dynamicList.size();i++) { String
		* text=dynamicList.get(i).getText(); System.out.println("Text is"+" "+ text);
		* if(text.contains("Mumbai, Suburban, Maharashtra, India")) {
		* dynamicList.get(i).click(); break; }
		*
		* }
		*/
